...
layers: {
  basic: {
    x -> y
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 3, Column: 4, Byte: -1},
    ...
    layers: {
      inner: {
        x -> y
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 5, Column: 4, Byte: -1},
...
layers: {
	outer: {
		layers: {
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 8, Column: 4, Byte: -1},
...
wumbo: {
  car
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 2, Column: 4, Byte: -1},
			want:     nil,
		},
		{
...
layers: {
    ...
    wumbo: {
      car
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 4, Column: 4, Byte: -1},
		...
		layers: {
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 1, Column: 1, Byte: -1},
			want:     nil,
		},
		{
		...
		layers: {
			...
			path:     "index.d2",
			position: d2ast.Position{Line: 3, Column: 2, Byte: -1},
			want:     []string{"layers", "basic"},
		},
	}
